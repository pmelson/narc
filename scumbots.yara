rule posh_find {
  ...
  strings:
    ...
    $posh_search_term10 = "_-bxor" nocase
    $posh_search_term11 = "[system.convert]::" nocase
    $posh_search_term12 = "frombase64string(" nocase
    $posh_search_term13 = "new-object system.io." nocase
    $posh_search_term14 = "[system.net." nocase
    $posh_search_term15 = "system.reflection.assemblyname" nocase
    $posh_search_term17 = "x509enrollment.cbinaryconverter" nocase
    $posh_search_term18 = "convertto-securestring" nocase
    $posh_search_term19 = "iex(" nocase
    $posh_search_term20 = "|iex" nocase
